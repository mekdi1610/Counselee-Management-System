...
<body>
	...
	$sql4="INSERT INTO recent (Code) VALUES ('$_POST[Code]')";
		if (mysqli_query($con,$sql4))
{
	...
	<div class="control-group">
				...
				<textarea class="span12" style="height: 70px; resize: none;" name="Assessment"><?php echo $Assessment;?></textarea>
					...
					<div class="control-group">
				<div class="controls">
				<a href="../js/PreviousSession.php"><button class="btn">Previous Session</button></a>
				</div>
				</div>
		...
		<div class="controls">
			<input type="text" id="Session" name="Session" placeholder="" value='<?php echo $SN;?>' class="span8">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" id="RD" name="Dates" placeholder="" class="span8" onclick="getDate()">
		...
		<div class="controls">
			<input type="text" id="Goal" name="Goal" placeholder="" class="span8">
	...
	<div class="control-group">
				...
				<div class="row-fluid">
				<textarea class="span12" style="height: 70px; resize: none;" name="Issues"></textarea>
			</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" id="Assignment" name="Assignment" placeholder="" class="span8">
		...
		<div class="controls">
			<input type="text" id="Plan" name="Plan" placeholder="" class="span8">
	...
	<script src="../js/PatientInformation.js" type="text/javascript"></script>
	<script src="../js/PreviousSession.js" type="text/javascript"></script>
